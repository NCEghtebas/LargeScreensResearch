    ...
    for (circle_point of circle_point_array) {
      if (i < 160){
        switch (basket_initial_alphabet2[i]) {
          ...
          case 'K':
            // if this k circle being placed is the 4rth or 5th circle
            if ( last_two.indexOf(circle_point) != -1 ) { 
              // make this circle a random letter and initialize it as red
              var rand_letter = getRandom(hard_sort_alphabet);
              switch (rand_letter) {
          ...
          case 'R':
            // if this r circle being placed is the 4rth or 5th circle
            if ( last_two.indexOf(circle_point) != -1 ) { 
              // make this circle a random letter and initialize it as red
              var rand_letter = getRandom(hard_sort_alphabet);
              switch (rand_letter) {
...
// function colorCheckOnCreate() {
//   // for (name of circleNames) {
//   //   console.log(name);
//   // }s
